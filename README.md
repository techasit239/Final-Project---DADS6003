...
เราได้ออกแบบการทดลองออกเป็นทั้งหมด **5 รูปแบบ** โดยแบ่งเป็นกลุ่ม **Reproduce** (ทำซ้ำงานวิจัยเดิม) และกลุ่ม **New Ideas** (แนวคิดใหม่) เพื่อเปรียบเทียบประสิทธิภาพตั้งแต่ระดับที่ทำตามงานวิจัย (Research Baseline) ไปจนถึงระดับผสมผสาน (Hybrid) ดังนี้
