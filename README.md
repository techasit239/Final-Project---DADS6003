...
<img width="634" height="528" alt="{329DF658-3BF2-4864-94B5-D2C3BC9E4F20}" src="https://github.com/user-attachments/assets/4e9a47e2-4115-43b0-bec0-a870a19a8094" />
   ...
   * จากการเปรียบเทียบผลการทดลองทั้ง 5 รูปแบบ (ตั้งแต่การทำซ้ำงานวิจัยเดิม ไปจนถึงการนำเสนอไอเดียใหม่) พบว่าแนวทางการวิเคราะห์ **เนื้อหา (Content-based) หรือ TF-IDF** ใน **Experiment 2** ให้ผลลัพธ์ที่ดีที่สุด เมื่อเปรียบเทียบกับการวิเคราะห์ที่**สไตล์การเขียน (Stylometric)** ที่ถูกใส่เข้าไปในการทดลองอื่น
